...
class FixedDepositsControllerTest < ActionController::TestCase
  ...
  test "should create fixed_deposit" do
    assert_difference('FixedDeposit.count') do
      post :create, fixed_deposit: { account_number: @fixed_deposit.account_number, customer_id: @fixed_deposit.customer_id, opening_date: @fixed_deposit.opening_date }
    end
  ...
  test "should update fixed_deposit" do
    patch :update, id: @fixed_deposit, fixed_deposit: { account_number: @fixed_deposit.account_number, customer_id: @fixed_deposit.customer_id, opening_date: @fixed_deposit.opening_date }
    assert_redirected_to fixed_deposit_path(assigns(:fixed_deposit))
  end
